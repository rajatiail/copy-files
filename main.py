...
def by_xl(xl_file, folder_to_search):
    ...
    for file, month_folder in zip(data.DOCUEMNT_NAME, data.month_year):
        month_folder = os.path.join(folder_to_search, month_folder)
        data.loc[data.DOCUEMNT_NAME == file, 'found'] = find_file(file, month_folder)
